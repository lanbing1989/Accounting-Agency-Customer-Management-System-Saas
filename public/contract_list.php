...
$query = "SELECT * FROM contracts $where ORDER BY id DESC";
...
<div class="container mt-4">
    ...
    <table class="table table-bordered table-hover align-middle bg-white">
        ...
        <tr>
            ...
            <td>
                <a href="contract_edit.php?id=<?=urlencode($row['id'])?>" class="btn btn-sm btn-outline-primary">编辑</a>
                <a href="payment_list.php?contract_id=<?=urlencode($row['id'])?>" class="btn btn-sm btn-outline-secondary">收费记录</a>
            </td>
        </tr>
        <?php endwhile; ?>
        </tbody>
